...
Use existing model results to calculate dynamic accuracy metrics
"""
...
def calculate_proper_metrics():
    """Calculate proper cricket prediction metrics from existing results"""
...
if __name__ == "__main__":
    results = calculate_proper_metrics()
