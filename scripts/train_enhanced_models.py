"""
Train Enhanced Models with Rich Pre-Match Features
Use the enhanced dataset with historical form data
"""
...
def train_enhanced_models():
    """Train models with enhanced pre-match features"""
    print("TRAINING ENHANCED MODELS - RICH PRE-MATCH FEATURES")
    print("=" * 70)
    
    # Load enhanced datasets
    train_df = pd.read_csv('data/enhanced_train_dataset.csv')
    test_df = pd.read_csv('data/enhanced_test_dataset.csv')
    ...
    print(f"Feature names: {feature_cols[:15]}...")
    ...
    # Compare models
    print(f"\n" + "="*90)
    print("ENHANCED MODEL COMPARISON - RICH PRE-MATCH FEATURES")
    print("="*90)
    ...
    for model_name, model in models.items():
        with open(f'models/{model_name}_enhanced.pkl', 'wb') as f:
            pickle.dump(model, f)
        print(f"Model saved: models/{model_name}_enhanced.pkl")
    
    # Save scaler
    with open('models/scaler_enhanced.pkl', 'wb') as f:
        pickle.dump(scaler, f)
    print(f"Scaler saved: models/scaler_enhanced.pkl")
    
    # Save results
    comparison_df.to_csv('models/enhanced_model_comparison.csv', index=False)
    print(f"Comparison saved: models/enhanced_model_comparison.csv")
    
    # Honest assessment
    print(f"\n" + "="*70)
    print("HONEST ASSESSMENT - ENHANCED FEATURES")
    print("="*70)
    ...
    if best_accuracy < 40:
        print(f"\nVERDICT: POOR - Still needs significant improvement")
...
if __name__ == "__main__":
    models, results, comparison, best = train_enhanced_models()
